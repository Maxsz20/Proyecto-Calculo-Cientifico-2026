...
\begin{enumerate}
	...
	Una vez obtenidas las funciones interpolantes $x(t)$ e $y(t)$ --- ya sea mediante polinomios de Lagrange por trozos o \textit{splines} --- se requiere calcular la integral (\ref{eq:area_param}). Para ello se puede emplear cualquier regla de cuadratura; en particular, la \textbf{regla de Simpson compuesta} resulta adecuada por su buen compromiso entre sencillez y precisión \cite{burden02}. El integrando es
	\[
	h(t) = x(t)\,y'(t) - y(t)\,x'(t),
	\]
